...
map("n", "<leader>w1", function() harpoon:list():select(1) end, { desc = "2st window via harpoon" })
map("n", "<leader>w3", function() harpoon:list():select(3) end, { desc = "3rd window via harpoon" })
map("n", "<leader>w4", function() harpoon:list():select(4) end, { desc = "4th window via harpoon" })
